...
public class BorrowedView extends JPanel {
	...
	public BorrowedView() {
		...
		/* Queries the database, and populate objs with the ResultSet given. 
		 * We'll use this data to populate a jtable which has a list of all the items
		 * where the return date is not null (the item has been returned)
		 */
		try {
