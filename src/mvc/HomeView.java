...
public class HomeView extends JPanel {
	...
	public HomeView() {
		...
		gl_menuBar.setHorizontalGroup(gl_menuBar.createParallelGroup(Alignment.LEADING).addGroup(gl_menuBar
				...
				.addContainerGap()));
		gl_menuBar.setVerticalGroup(gl_menuBar.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_menuBar.createSequentialGroup().addGap(30).addComponent(btnBorrow).addGap(18)
						.addComponent(btnShop).addPreferredGap(ComponentPlacement.RELATED, 263, Short.MAX_VALUE)
						.addComponent(btnLogout).addPreferredGap(ComponentPlacement.UNRELATED)
		...
		gl_defaultcard.setHorizontalGroup(gl_defaultcard.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_defaultcard.createSequentialGroup().addContainerGap().addComponent(lblName)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(nameVar)
						.addContainerGap(717, Short.MAX_VALUE)));
		gl_defaultcard.setVerticalGroup(gl_defaultcard.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_defaultcard
						.createSequentialGroup().addContainerGap().addGroup(gl_defaultcard
								.createParallelGroup(Alignment.BASELINE).addComponent(lblName).addComponent(nameVar))
