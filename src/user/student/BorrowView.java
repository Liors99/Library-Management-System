	...
	public BorrowView() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						...
						.addGap(18).addComponent(searchBtn).addContainerGap(502, Short.MAX_VALUE)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						...
						.addGap(32).addComponent(notFound).addContainerGap(374, Short.MAX_VALUE)));
		...
		searchBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (book.findBook(textField.getText())) {
					...
					Book_view b_frame = new Book_view("Reserve");
