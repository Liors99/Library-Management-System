...
public class ReserveView {
	...
	public ReserveView(String button_type) {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap(158, Short.MAX_VALUE)
						...
						.addGap(121))
				.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup().addGap(142)
						.addComponent(lblNumberToReserve).addContainerGap(148, Short.MAX_VALUE)));
		gl_panel.setVerticalGroup(
				gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup().addContainerGap()
								...
								.addGap(18).addComponent(lblNumberToReserve).addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(textField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
